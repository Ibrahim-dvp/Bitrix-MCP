...
import { contactAPI } from "../lib/bitrix-api.js";
import type { ToolDefinition } from "../types/index.js";

const FIELDS = ["ID", "NAME", "LAST_NAME", "PHONE", "EMAIL", "COMPANY_ID", "POST"];
...
export const contactTools: ToolDefinition[] = [
...

	{
		...
		description:
			"Search for contacts by name. Searches both first and last names.",
		inputSchema: {
			type: "object",
			properties: {
				query: {
